...
commands!(
    C002 C006 C009 C010 C011 C012 C013 C014 C015 C018 C019 C021 C031 C033 C034 C042 C043 C053
    C055 C056 C057 C058 C059 C063 C067 C068 C075 C082 C083 C084 C088 C089 C093 C094 C095 C100
    C104 C107 C109 C110 C112 C113 C117 C118 C120 C124 C125 C131 C133 C136 C139 C142 C143 C144
    C161 C168 C173 C174 C175 C176 C177 C178 C187 C188 C192 C194 C197 C198 C199 C202 C203 C204
    C211 C212 C215 C216 C225 C230 C234
);
